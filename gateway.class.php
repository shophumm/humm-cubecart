...
class Gateway {
    ...
    public function fixedVariables() {
        ...
        $hidden = array(
            ...
            'x_url_callback'               => $GLOBALS['storeURL'] . '/modules/gateway/Humm/call.php',
            'x_url_complete'               => $GLOBALS['storeURL'] . '/modules/gateway/Humm/process.php',
            'x_url_cancel'                 => $GLOBALS['storeURL'] . '/modules/gateway/Humm/cancel.php',
        ...
        $hidden['x_signature'] = $this->_humm_sign( $hidden, $this->_module['api_key'] );
    ...
    private function _call_or_process() {
        ...
        $transData['gateway']     = 'Humm';
        $order->logTransaction( $transData );
    }

    private function _humm_sign( $query, $api_key ) {
        $clear_text = '';
        ksort( $query );
